...
grid <- expand.grid(minsplit = seq(from = 1, to = 100, by = 5),
                    maxdepth = seq(from = 1, to = 30, by = 4),
                    minbucket = seq(from = 1, to = 100, by = 10),
...
preditos_grid_treino <- predict(arvore_grid, treino)
...
# Valores preditos pela árvore (base de teste)
preditos_grid_teste <- predict(arvore_grid, teste)
